...
def save_event(datum: str, beginn: str, ende: str, grund: str, verursacher: str, auswirkung: int) -> None:
    """
    ...
    try:
        ...
        logging.info(f"Lärmdaten gespeichert: {datum}, {beginn}-{ende}, {grund}, {verursacher}, {auswirkung}")
